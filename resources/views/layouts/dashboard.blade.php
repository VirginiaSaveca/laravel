...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <a href="{{ route('profile.edit') }}" class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                ...
                @auth
                    <form class="form-inline mb-4" method="POST" action="{{ route('logout') }}">
                        @csrf
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item" class="nav-link @if (request()->routeIs('employee')) active @endif">>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2023 <a href="https://adminlte.io">marcia saveca/a>.</strong>
            All rights reserved.
    ...
    <script src="{{ asset('ssets/plugins/daterangepicker/daterangepicker.js') }}"></script>
    <!-- Tempusdominus Bootstrap 4 -->
